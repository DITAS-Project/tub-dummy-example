...
public interface PatientApi {
    ...
    @ApiOperation(value = "", notes = "returns all the details of the patient", response = Patient.class, tags={  })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/patient/{SSN}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Patient> patientSSNGet(@ApiParam(value = "unique ID of a patient",required=true ) @PathVariable("SSN") Long SSN);
